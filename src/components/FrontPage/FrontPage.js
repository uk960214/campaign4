  ...
  return (
    <div className="content-area">
      ...
      >
        ...
        <filter id="shadow1">
          <feDropShadow dx="0" dy="0" stdDeviation="15" floodColor="#b6f4f4" />
        </filter>
        <filter id="shadow2">
          <feDropShadow dx="0" dy="0" stdDeviation="15" floodColor="#d2f3f2" />
        </filter>
        <filter id="shadow3">
          <feDropShadow dx="0" dy="0" stdDeviation="20" floodColor="#ffffff" />
        </filter>
      </svg>
      <br />
      <br />
