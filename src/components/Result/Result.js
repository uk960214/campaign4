                ...
                <section className='svgContainer'>
                    ...
                    <g clipPath="url(#clip0)">
                        ...
                        <g>
                            ...
                            <circle cx="0" cy="220.5" r="165.5" fill="#B6F4F4" style={{filter: 'url(#shadow1)'}}/>
                            <circle cx="0" cy="220.5" r="124.125" fill="#D2F3F2" style={{filter: 'url(#shadow2)'}}/>
                            <circle cx="0" cy="220.5" r="82.75" fill="#ffffff" style={{filter: 'url(#shadow3)'}}/>
                            <circle cx="1080" cy="220.5" r="165.5" fill="#B6F4F4" style={{filter: 'url(#shadow1)'}}/>
                            <circle cx="1080" cy="220.5" r="124.125" fill="#D2F3F2" style={{filter: 'url(#shadow2)'}}/>
                            <circle cx="1080" cy="220.5" r="82.75" fill="#ffffff" style={{filter: 'url(#shadow3)'}}/>
                            <ellipse cx="774.474" cy="219.774" rx="10.4745" ry="10.7737" fill="#D2F3F2"
                            style={{filter: 'url(#shadow4)'}}/>
                            <ellipse cx="826.423" cy="219.774" rx="10.4745" ry="10.7737" fill="#D2F3F2"
                            style={{filter: 'url(#shadow4)'}}/>
                            <ellipse cx="878.372" cy="219.774" rx="10.4745" ry="10.7737" fill="#D2F3F2"
                            style={{filter: 'url(#shadow4)'}}/>
                            <ellipse cx="201.474" cy="219.774" rx="10.4745" ry="10.7737" fill="#D2F3F2"
                            style={{filter: 'url(#shadow4)'}}/>
                            <ellipse cx="253.423" cy="219.774" rx="10.4745" ry="10.7737" fill="#D2F3F2"
                            style={{filter: 'url(#shadow4)'}}/>
                            <ellipse cx="305.372" cy="219.774" rx="10.4745" ry="10.7737" fill="#D2F3F2"
                            style={{filter: 'url(#shadow4)'}}/>
                        </g>
